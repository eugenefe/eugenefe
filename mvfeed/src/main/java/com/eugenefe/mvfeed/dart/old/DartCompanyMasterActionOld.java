...
public class DartCompanyMasterActionOld {
	private static final Logger logger = LoggerFactory.getLogger(DartCompanyMasterActionOld.class);
//	private Properties properties = new Properties();
	...
	public DartCompanyMasterActionOld() {
	}
