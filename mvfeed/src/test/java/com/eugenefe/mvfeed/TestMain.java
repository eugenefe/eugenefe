...
//	    flightLookup();
	...
	public static void flightLookup() { 
	    DefaultHttpClient httpclient = new DefaultHttpClient(); 
	  
	    try
	    { 
	        // Specify values for path parameters (shown as {...}) 
//	        URIBuilder builder = new URIBuilder("http://api.flightlookup.com/otajtimetable/v1/TimeTable/");
	        URIBuilder builder = new URIBuilder("http://api.flightlookup.com/otajtimetable/v1/TimeTable/");
	        // Specify your developer key 
	        builder.setParameter("key", "FBE6EEBC-D907-4F36-AE76-5FEBCB5BE9DE"); 
	        // Specify values for the following required parameters 
	        builder.setParameter("From", "jfk"); 
	        builder.setParameter("To", "ICN"); 
	        builder.setParameter("Date", "12/17/2013"); 
	        // Specify values for optional parameters, as needed 
	        //builder.setParameter("Sort", ""); 
//	        builder.setParameter("Airline", ""); 
	        builder.setParameter("Connection", "NONSTOP"); //NONSTOP, DIRECT, 1STOP, MORE;  
	        //builder.setParameter("Count", ""); 
//	        builder.setParameter("Interline", "Y"); 
