...
public interface IHiFiveMc extends Library {
	IHiFiveMc INSTANCE = (IHiFiveMc)Native.loadLibrary("takion77_HiFive_MC", IHiFiveMc.class);
	
	public double HiFive_MC(			//OUT: 가격 
